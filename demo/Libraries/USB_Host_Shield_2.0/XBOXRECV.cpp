...
void XBOXRECV::readReport(uint8_t controller) {
        ...
        hatValue[controller][LeftStickX] = (int16_t)(((uint16_t)readBuf[11] << 8) | readBuf[10]);
        hatValue[controller][LeftStickY] = (int16_t)(((uint16_t)readBuf[13] << 8) | readBuf[12]);
        hatValue[controller][RightStickX] = (int16_t)(((uint16_t)readBuf[15] << 8) | readBuf[14]);
        hatValue[controller][RightStickY] = (int16_t)(((uint16_t)readBuf[17] << 8) | readBuf[16]);
...
int16_t XBOXRECV::getAnalogStick(AnalogStickEnum a, uint8_t controller) {
