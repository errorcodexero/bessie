...
void XBOXONE::readReport() {
        ...
        hatValue[LeftStickX] = (int16_t)(((uint16_t)readBuf[11] << 8) | readBuf[10]);
        hatValue[LeftStickY] = (int16_t)(((uint16_t)readBuf[13] << 8) | readBuf[12]);
        hatValue[RightStickX] = (int16_t)(((uint16_t)readBuf[15] << 8) | readBuf[14]);
        hatValue[RightStickY] = (int16_t)(((uint16_t)readBuf[17] << 8) | readBuf[16]);
...
int16_t XBOXONE::getAnalogStick(AnalogStickEnum a) {
        return hatValue[a];
}
