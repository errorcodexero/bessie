...
void loop() {
  ...
  if (PS3.PS3Connected || PS3.PS3NavigationConnected) {
    if (PS3.getAnalogSwitch(LeftSwitchX) > 137 || PS3.getAnalogSwitch(LeftSwitchX) < 117 || PS3.getAnalogSwitch(LeftSwitchY) > 137 || PS3.getAnalogSwitch(LeftSwitchY) < 117 || PS3.getAnalogSwitch(RightSwitchX) > 137 || PS3.getAnalogSwitch(RightSwitchX) < 117 || PS3.getAnalogSwitch(RightSwitchY) > 137 || PS3.getAnalogSwitch(RightSwitchY) < 117) {
      Serial.print(F("\r\nLeftSwitchX: "));
      Serial.print(PS3.getAnalogSwitch(LeftSwitchX));
      Serial.print(F("\tLeftSwitchY: "));
      Serial.print(PS3.getAnalogSwitch(LeftSwitchY));
      if (PS3.PS3Connected) { // The Navigation controller only have one joystick
        Serial.print(F("\tRightSwitchX: "));
        Serial.print(PS3.getAnalogSwitch(RightSwitchX));
        Serial.print(F("\tRightSwitchY: "));
        Serial.print(PS3.getAnalogSwitch(RightSwitchY));
      }
    }
