...
void XBOXOLD::readReport() {
        ...
        hatValue[LeftStickX] = (int16_t)(((uint16_t)readBuf[12] << 8) | readBuf[13]);
        hatValue[LeftStickY] = (int16_t)(((uint16_t)readBuf[14] << 8) | readBuf[15]);
        hatValue[RightStickX] = (int16_t)(((uint16_t)readBuf[16] << 8) | readBuf[17]);
        hatValue[RightStickY] = (int16_t)(((uint16_t)readBuf[18] << 8) | readBuf[19]);
...
int16_t XBOXOLD::getAnalogStick(AnalogStickEnum a) {
        return hatValue[a];
}
