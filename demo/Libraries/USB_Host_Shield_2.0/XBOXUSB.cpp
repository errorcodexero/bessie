...
void XBOXUSB::readReport() {
        ...
        hatValue[LeftStickX] = (int16_t)(((uint16_t)readBuf[7] << 8) | readBuf[6]);
        hatValue[LeftStickY] = (int16_t)(((uint16_t)readBuf[9] << 8) | readBuf[8]);
        hatValue[RightStickX] = (int16_t)(((uint16_t)readBuf[11] << 8) | readBuf[10]);
        hatValue[RightStickY] = (int16_t)(((uint16_t)readBuf[13] << 8) | readBuf[12]);
...
int16_t XBOXUSB::getAnalogStick(AnalogStickEnum a) {
        return hatValue[a];
}
